...
function buildWorkspace(managedDirectory) {
  ...
  // Canonical project rows mirror the legacy Theme rows so provenance
  // references can target the v2 project identity without changing the
  // existing demo Theme collection.
  put(
    "project",
    record(
      {
