...
export type ActionAvailability =
  "always" | "when-selection" | "when-editing" | "when-ai-enabled" | "when-theme-selected";
...
export const ACTION_DEFINITIONS = {
  ...
  themeAddTask: {
    ...
    icon: IconPlus,
    role: "primary",
    availability: "when-theme-selected",
  },
  themeAddReport: {
    id: "themeAddReport",
    label: "報告書を追加",
