      ...
      */}
      <section className="panel report-section">
            ...
            {defaultPrompt ? (
              <>
                <Button
                  variant="secondary"
                  compact
                  onClick={() => copyNoteText(defaultPrompt, "報告書プロンプトをコピーしました。")}
                >
                  <IconCopy size={15} />
                  プロンプトをコピー
                </Button>
        ...
        <div className="report-list">
          ...
          {!reportNotes.length && (
            <EmptyState title="報告書はまだありません" action="報告書を追加" onAction={addReport} />
          )}
        </div>
      </section>
            ...
            {aiPack.files.map((file) => (
              <details key={file.name} className="theme-ai-pack-file">
                <summary>
                  ...
                  <span>
                    {file.includedCount}件 / {file.characterCount.toLocaleString("ja-JP")}文字
                  </span>
                </summary>
      ...
      <div className="dashboard-grid theme-overview-grid">
        ...
        <section className="panel">
          ...
          <SimpleRows
            records={milestones as unknown as BaseRecord[]}
