      ...
      if (candidate.type === "item") {
        operations.push({
          ...
          entity: {
            ...
            priority: str(entry.priority) || str(base.priority) || "normal",
            ...
            due_date: str(entry.due_date) || str(entry.due) || str(base.due_date) || null,
            schedule_status: str(entry.schedule_status) || (entry.due_date || entry.planned_end ? "scheduled" : "unscheduled"),
            schedule_confidence: str(entry.schedule_confidence) || "tentative",
            date_granularity: str(entry.date_granularity) || "day",
            progress: num(entry.progress ?? base.progress),
