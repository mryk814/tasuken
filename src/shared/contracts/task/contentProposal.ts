...
export const contentProposalActorSchema = z.object({
  kind: z.literal("ai_agent"),
  id: boundedText(200).optional(),
}).strict();

export const contentProposalRepositoryContextSchema = z.object({
...
export const proposeContentRequestSchema = z.discriminatedUnion("kind", [
  z.object({
    ...requestBase,
...
export const proposeContentResponseSchema = z.object({
