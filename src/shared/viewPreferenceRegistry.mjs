...
function normalizeNotes(value) {
  ...
  return {
    ...
    sortOrder: oneOf(
      ...
      NOTES_DEFAULT.sortOrder,
    ),
    themeId: text(raw.themeId, NOTES_DEFAULT.themeId),
    listWidth:
      raw.listWidth === null ? null : Math.max(180, Math.min(800, finite(raw.listWidth, 280))),
...
function normalizeChatRefs(value) {
  ...
  return {
    ...
    statusFilter: oneOf(
      raw.statusFilter,
      ["all", "inbox", "adopted"],
      CHAT_REFS_DEFAULT.statusFilter,
    ),
    listMode: oneOf(raw.listMode, ["active", "archive"], CHAT_REFS_DEFAULT.listMode),
    includeArchivedInSearch: bool(
      raw.includeArchivedInSearch,
      CHAT_REFS_DEFAULT.includeArchivedInSearch,
    ),
  };
}
...
function normalizeTodo(value) {
  ...
  const taskFilters = {
    tab: oneOf(
      filters.tab,
      ["open", "today", "overdue", "no-schedule", "done"],
      TODO_DEFAULT.taskFilters.tab,
    ),
    themeId: text(filters.themeId, TODO_DEFAULT.taskFilters.themeId),
    state: oneOf(
      filters.state,
      ["", "todo", "doing", "waiting", "review", "done", "cancelled"],
      "",
    ),
    priority: oneOf(filters.priority, ["", "high", "normal"], ""),
    schedule: oneOf(
      filters.schedule,
      ["", "scheduled", "no-schedule", "overdue", "this-week", "today"],
      "",
    ),
    rangeSemantics: oneOf(
      filters.rangeSemantics,
      ["", "execution_window", "ongoing_period", "unspecified_range"],
      "",
    ),
  };
  return {
...
function normalizeArtifacts(value) {
  ...
  return {
    ...
    typeFilter: oneOf(
      raw.typeFilter,
      ["all", "image", "spreadsheet", "pdf", "markdown", "presentation", "other"],
      ARTIFACTS_DEFAULT.typeFilter,
    ),
    sortOrder: oneOf(
      raw.sortOrder,
      ["newest", "oldest", "recent_opened", "name"],
      ARTIFACTS_DEFAULT.sortOrder,
    ),
  };
}
...
function normalizeSketchLibrary(value) {
  ...
  return {
    ...
    sortOrder: oneOf(
      raw.sortOrder,
      ["updated_desc", "updated_asc", "title"],
      SKETCH_LIBRARY_DEFAULT.sortOrder,
    ),
  };
}
...
function normalizeToolPresets(value) {
  ...
  return Object.fromEntries(
    Object.entries(SKETCH_TOOL_PRESETS_DEFAULT).map(([tool, fallback]) => {
...
const definitions = [
  {
    ...
    defaultValue: false,
    legacyKeys: [
      "tasken:shell:sidebar-collapsed:v1",
      "tasuken-research-desk:shell:sidebar-collapsed:v1",
    ],
    normalize: (value) => bool(value, false),
  },
  {
    id: "shell.sidebarWidth",
    surfaceId: "shell",
    scope: "workspace",
    scopeKey: "",
    sortKey: "none",
    ...
    defaultValue: 220,
    legacyKeys: [],
    normalize: (value) => Math.max(180, Math.min(360, finite(value, 220))),
  },
  {
    id: "shell.zoomFactor",
    surfaceId: "shell",
    ...
    schemaVersion: 1,
    defaultValue: 1,
    legacyKeys: ["tasken:shell:zoom-factor:v1", "tasuken-research-desk:shell:zoom-factor:v1"],
    normalize: (value) => Math.max(0.7, Math.min(1.5, finite(value, 1))),
  },
  {
    ...
    legacyKeys: ["tasken:notes:prefs:v1", "tasuken-research-desk:notes:prefs:v1"],
    normalize: normalizeNotes,
    migrate: (value) => normalizeNotes(value),
  },
  {
    id: "chatRefs.preferences",
    surfaceId: "chat-refs",
    scope: "workspace",
    scopeKey: "",
    sortKey: "sortOrder",
    direction: "sortOrder",
    schemaVersion: 1,
    defaultValue: CHAT_REFS_DEFAULT,
    legacyKeys: ["tasken:chat-refs:prefs:v1", "tasuken-research-desk:chat-refs:prefs:v1"],
    normalize: normalizeChatRefs,
  },
  {
    id: "chatRefs.collapsedGroups",
    surfaceId: "chat-refs",
    scope: "workspace",
    scopeKey: "",
    sortKey: "collapsedGroups",
    direction: "none",
    schemaVersion: 1,
    defaultValue: [],
    legacyKeys: [
      "tasken:chat-refs:collapsed-groups:v1",
      "tasuken-research-desk:chat-refs:collapsed-groups:v1",
    ],
    normalize: stringArray,
  },
  {
    id: "timeline.preferences",
    surfaceId: "timeline",
    scope: "workspace",
    scopeKey: "",
    sortKey: "dayWidth",
    direction: "none",
    schemaVersion: 3,
    defaultValue: TIMELINE_DEFAULT,
    legacyKeys: ["tasken:timeline:prefs:v6", "tasuken-research-desk:timeline:prefs:v6"],
    normalize: normalizeTimeline,
    migrate: (value) => normalizeTimeline(value),
  },
  {
    id: "todo.preferences",
    surfaceId: "todo",
  ...
  },
  {
    ...
    direction: "sortOrder",
    schemaVersion: 1,
    defaultValue: ARTIFACTS_DEFAULT,
    legacyKeys: ["tasken:artifacts:prefs:v1", "tasuken-research-desk:artifacts:prefs:v1"],
    normalize: normalizeArtifacts,
  },
  {
    id: "sketch.libraryPreferences",
    surfaceId: "sketch",
    scope: "workspace",
    scopeKey: "",
    sortKey: "sortOrder",
    direction: "sortOrder",
    schemaVersion: 1,
    defaultValue: SKETCH_LIBRARY_DEFAULT,
    legacyKeys: ["tasken:sketch:library-prefs:v1", "tasuken-research-desk:sketch:library-prefs:v1"],
    normalize: normalizeSketchLibrary,
  },
  {
    id: "sketch.toolPresets",
    surfaceId: "sketch-editor",
    scope: "workspace",
    scopeKey: "",
    sortKey: "none",
    direction: "none",
    schemaVersion: 1,
    defaultValue: SKETCH_TOOL_PRESETS_DEFAULT,
    legacyKeys: ["tasken:sketch:tool-presets:v1", "tasuken-research-desk:sketch:tool-presets:v1"],
    normalize: normalizeToolPresets,
  },
  {
    id: "sketch.shapeKind",
    surfaceId: "sketch-editor",
    ...
    legacyKeys: [
      "tasken:sketch:shape-kind:v2",
      "tasken:sketch:shape-kind:v1",
      "tasuken-research-desk:sketch:shape-kind:v2",
    ],
    normalize: (value) =>
      oneOf(
        value,
  ...
  },
  {
    ...
    legacyKeys: ["tasken:sketch:eraser-mode:v1", "tasuken-research-desk:sketch:eraser-mode:v1"],
    normalize: (value) => oneOf(value, ["partial", "stroke"], "partial"),
  },
];
...
export function normalizeViewPreference(id, value, fromVersion = 1) {
  ...
  const migrated =
    typeof definition.migrate === "function" ? definition.migrate(value, fromVersion) : value;
