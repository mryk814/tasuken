...
const definitions = /** @type {const} */ ([
  ...
  },
  {
    type: "note",
    collectionKey: "notes",
    domainCollectionKey: "notes",
    label: "Note",
    iconKey: "note",
    projection: "canonical",
    themePolicy: "optional",
    themeField: "project_id",
    legacyThemeFields: ["theme_id"],
    requiredFields: ["title"],
  },
  {
    type: "link",
  ...
  {
    type: "status_update",
    collectionKey: "status_updates",
    label: "Status update",
    iconKey: "message",
    projection: "legacy",
    themePolicy: "required",
    themeField: "theme_id",
    requiredFields: ["theme_id", "summary"],
  },
  {
    type: "source_record",
    collectionKey: "source_records",
    label: "Source record",
    iconKey: "database",
    projection: "legacy",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["source_title"],
  },
  {
    type: "entity_source",
    collectionKey: "entity_sources",
    label: "Entity source",
    iconKey: "link",
    projection: "legacy",
    themePolicy: "none",
  ...
  },
  {
    ...
    collectionKey: "field_definitions",
    label: "Field definition",
    iconKey: "forms",
    projection: "legacy",
    themePolicy: "optional",
    themeField: "theme_id",
    requiredFields: ["name", "field_type", "applies_to"],
  },
  {
    type: "field_value",
    collectionKey: "field_values",
    label: "Field value",
    iconKey: "forms",
    projection: "legacy",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["field_definition_id", "entity_type", "entity_id"],
  },
  {
    type: "log_entry",
    collectionKey: "log_entries",
    label: "Log entry",
    iconKey: "history",
    projection: "legacy",
    themePolicy: "optional",
  ...
  {
    type: "knowledge_node",
    collectionKey: "knowledge_nodes",
    domainCollectionKey: "knowledge_nodes",
    label: "Knowledge node",
    iconKey: "bulb",
    projection: "legacy",
    themePolicy: "optional",
    themeField: "theme_id",
    requiredFields: ["node_type", "title"],
  },
  {
    type: "ai_proposal",
    collectionKey: "ai_proposals",
    label: "AI proposal",
    iconKey: "sparkles",
    projection: "legacy",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["source", "payload_type", "status"],
  },
  {
    type: "resource",
    collectionKey: "resources",
    domainCollectionKey: "resources",
    label: "Resource",
    iconKey: "folder",
    projection: "canonical",
    themePolicy: "optional",
  ...
  },
  {
    ...
    domainCollectionKey: "projects",
    label: "Theme",
    iconKey: "palette",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["name", "state"],
  },
  {
    type: "repository_context",
    collectionKey: "repository_contexts",
    domainCollectionKey: "repository_contexts",
  ...
  {
    type: "working_copy",
    collectionKey: "working_copies",
    domainCollectionKey: "working_copies",
    label: "Working copy",
    iconKey: "git-branch",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["repository_context_id", "device_id", "storage_root_id"],
  },
  {
    type: "agent_session",
    collectionKey: "agent_sessions",
    domainCollectionKey: "agent_sessions",
    label: "Agent session",
    iconKey: "robot",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["started_at", "status", "client_kind"],
  },
  {
    type: "capture_entry",
    collectionKey: "capture_entrys",
    domainCollectionKey: "capture_entries",
    label: "Capture",
    iconKey: "inbox",
    projection: "canonical",
    themePolicy: "optional",
    themeField: "project_id",
    legacyThemeFields: ["theme_id"],
    requiredFields: ["text", "captured_at", "state"],
  },
  {
    type: "task",
    collectionKey: "tasks",
    domainCollectionKey: "tasks",
    label: "Task",
    iconKey: "check",
    projection: "canonical",
    themePolicy: "optional",
  ...
  {
    type: "work_receipt",
    collectionKey: "work_receipts",
    domainCollectionKey: "work_receipts",
    label: "Work receipt",
    iconKey: "history",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["task_id", "executor_kind", "executor_label", "reported_at", "summary"],
  },
  {
    type: "waiting",
    collectionKey: "waitings",
    domainCollectionKey: "waitings",
    label: "Waiting",
    iconKey: "clock",
    projection: "canonical",
    themePolicy: "optional",
    themeField: "project_id",
    legacyThemeFields: ["theme_id"],
    requiredFields: ["title", "waiting_for", "state"],
  },
  {
    type: "plan_node",
    collectionKey: "plan_nodes",
    domainCollectionKey: "plan_nodes",
    label: "Plan node",
    iconKey: "route",
    projection: "canonical",
    themePolicy: "optional",
    themeField: "project_id",
    legacyThemeFields: ["theme_id"],
    requiredFields: ["title", "type", "state"],
  },
  {
    type: "schedule",
    collectionKey: "schedules",
    domainCollectionKey: "schedules",
    label: "Schedule",
    iconKey: "calendar",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["owner_type", "owner_id", "date_kind", "confidence", "granularity"],
  },
  {
    type: "reference",
    collectionKey: "references",
    domainCollectionKey: "references",
    label: "Reference",
    iconKey: "arrows",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["source_type", "source_id", "target_type", "target_id", "relation_type"],
  },
  {
    type: "task_dependency",
    collectionKey: "task_dependencies",
    domainCollectionKey: "task_dependencies",
    label: "Task dependency",
    iconKey: "arrows",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["task_id", "depends_on_task_id"],
  },
  {
    type: "plan_dependency",
    collectionKey: "plan_dependencies",
    domainCollectionKey: "plan_dependencies",
    label: "Plan dependency",
    iconKey: "arrows",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["plan_node_id", "depends_on_plan_node_id"],
  },
  {
    type: "knowledge_edge",
    collectionKey: "knowledge_edges",
    domainCollectionKey: "knowledge_edges",
    label: "Knowledge edge",
    iconKey: "arrows",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["source_node_id", "target_node_id", "relation_type"],
  },
  {
    type: "change_event",
    collectionKey: "change_events",
    domainCollectionKey: "change_events",
    label: "Change event",
    iconKey: "history",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["entity_type", "entity_id", "changed_at", "change_type", "source"],
  },
  {
    type: "artifact",
    ...
    themePolicy: "optional",
    themeField: "theme_id",
    requiredFields: ["title", "filename", "source_type", "source_id"],
  },
  {
    type: "sketch",
    collectionKey: "sketches",
    domainCollectionKey: "sketches",
    label: "Sketch",
    iconKey: "pencil",
    projection: "canonical",
    themePolicy: "optional",
  ...
  },
  {
    ...
    themeField: "project_id",
    legacyThemeFields: ["theme_id"],
    requiredFields: ["title", "schedule_kind", "state"],
  },
  {
    type: "habit_entry",
    collectionKey: "habit_entrys",
    domainCollectionKey: "habit_entries",
    label: "Habit entry",
    iconKey: "history",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["habit_id", "performed_on", "recorded_at"],
  },
  {
    type: "feed_reaction",
    collectionKey: "feed_reactions",
    domainCollectionKey: "feed_reactions",
    label: "Feed reaction",
    iconKey: "message",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["post_id", "kind", "created_at"],
  },
  {
    type: "feed_reply",
    collectionKey: "feed_replies",
    domainCollectionKey: "feed_replies",
    label: "Feed reply",
    iconKey: "message",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["post_id", "body", "created_at"],
  },
  {
    type: "feed_post",
    collectionKey: "feed_posts",
    domainCollectionKey: "feed_posts",
    label: "Feed post",
    iconKey: "message",
    projection: "canonical",
    themePolicy: "optional",
    themeField: "project_id",
    legacyThemeFields: ["theme_id"],
    requiredFields: ["title", "body_markdown", "published_at"],
  },
  {
    type: "maintenance",
    collectionKey: "maintenances",
    domainCollectionKey: "maintenances",
    label: "Maintenance",
    iconKey: "clock",
    projection: "canonical",
    themePolicy: "optional",
    themeField: "project_id",
    legacyThemeFields: ["theme_id"],
    requiredFields: ["title", "target", "action"],
  },
  {
    type: "maintenance_entry",
    collectionKey: "maintenance_entrys",
    domainCollectionKey: "maintenance_entries",
    label: "Maintenance entry",
    iconKey: "history",
    projection: "canonical",
    themePolicy: "none",
    themeField: null,
    requiredFields: ["maintenance_id", "performed_on", "recorded_at"],
  },
]);
...
export const entityDefinitions = Object.freeze(
  definitions.map(
    ...
    (definition) =>
      Object.freeze({
        ...
        payloadKind: "record",
        parseCreate: /** @param {unknown} payload */ (payload) =>
          parseCreatePayload(definition.type, payload),
        parseUpdate: /** @param {unknown} payload */ (payload) =>
          parseUpdatePayload(definition.type, payload),
...
const definitionsByType = new Map(
  entityDefinitions.map((definition) => [definition.type, definition]),
);
const definitionsByCollection = new Map(
  entityDefinitions.map((definition) => [definition.collectionKey, definition]),
);
...
export function assertEntityEnvelope(envelope) {
  ...
  assertEntityPayload(
    /** @type {RegistryEntityType} */ (envelope.type),
    envelope.entity ?? envelope.payload,
  );
  return envelope;
}
